...
Interfaces.Settings.registerGroup { 
    ...
    settings = {
        ...
        { key = "DELAY_CAM_DIST", renderer = "number", name = "DELAY_CAM_DIST", default = 200, description = 'Camera distance from head' },
        { key = "DELAY_CAM_Z_OFFSET", renderer = "number", name = "DELAY_CAM_Z_OFFSET", default = 150, description = 'Camera distance from ground' },
        { key = "DELAY_CAM_POS_SMOOTHING", renderer = "number", name = "DELAY_CAM_POS_SMOOTHING", default = 4, description = 'Smoothing for position' },
        { key = "DELAY_CAM_YAW_SMOOTHING", renderer = "number", name = "DELAY_CAM_YAW_SMOOTHING", default = 5, description = 'Smoothing for yaw' },
        { key = "DELAY_CAM_PITCH_SMOOTHING", renderer = "number", name = "DELAY_CAM_PITCH_SMOOTHING", default = 5, description = 'Smoothing for pitch' },
...
Interfaces.Settings.registerGroup { 
    ...
    permanentStorage = true,
    settings = {
        { key = "GRAB_KEY", renderer = "textLine", name = "GRAB_KEY", default = 'y', description = 'Keybinding for grab (lower-case)'},
        { key = "PUSH_KEY", renderer = "textLine", name = "PUSH_KEY", default = 'u', description = 'Keybinding for push (lower-case)'},
        { key = "PULL_KEY", renderer = "textLine", name = "PULL_KEY", default = 'i', description = 'Keybinding for pull (lower-case)'},
        { key = "LIFT_KEY", renderer = "textLine", name = "LIFT_KEY", default = 'o', description = 'Keybinding for lift (lower-case)'},
        { key = "DELAY_CAMERA_KEY", renderer = "textLine", name = "DELAY_CAMERA_KEY", default = 'p', description = 'Keybinding for "Jedi Academy Camera" (lower-case)'},
